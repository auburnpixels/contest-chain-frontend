      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-6 max-w-3xl text-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both">
                <h2 className="text-3xl font-semibold mb-6">The Challenge: Demonstrating Trust in Private Systems</h2>
                <p className="text-lg text-[var(--veristiq-slate-light)] leading-relaxed">
                    Most competition platforms operate on standard databases. These systems are effective for running competitions, but they are not designed to produce independent, tamper-evident evidence after a draw has taken place.
                    <br/><br/>
                    Screen recordings can show what happened on screen, but they do not provide cryptographic proof of what occurred at the data level.
                </p>
            </div>
        </section>
                ...
                <div className="space-y-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center group">
                        <div className="order-2 md:order-1 animate-in fade-in slide-in-from-left-8 duration-700 delay-300 fill-mode-both">
                             ...
                             <h3 className="text-2xl font-bold mb-4">Tamper-Evident Event Logging</h3>
                             <p className="text-lg text-[var(--veristiq-slate-light)] mb-6">
                                 Operators send competition entries and draw-related events to Veristiq via API. Each event is time-stamped, hashed, and linked to the previous event, creating an append-only audit record that cannot be altered without detection.
                             </p>
                        ...
                        <div className="order-1 md:order-2 bg-white p-8 rounded-xl border border-gray-200 shadow-sm font-mono text-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 animate-in fade-in slide-in-from-right-8 duration-700 delay-300 fill-mode-both">
                            ...
                            <div className="space-y-2 text-[var(--veristiq-slate)]">
                                <p><span className="text-black">"event_id"</span>: <span className="text-blue-600">"evt_8921..."</span>,</p>
                                <p><span className="text-black">"type"</span>: <span className="text-blue-600">"entry.created"</span>,</p>
                                <p><span className="text-black">"data"</span>: &#123; ... &#125;,</p>
                                <p><span className="text-black">"previous_hash"</span>: <span className="text-blue-600">"a7f3..."</span>,</p>
                                <p><span className="text-black">"hash"</span>: <span className="text-blue-600">"b8c9..."</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center group">
                         <div className="order-1 md:order-2 animate-in fade-in slide-in-from-right-8 duration-700 delay-400 fill-mode-both">
                             ...
                             <p className="text-lg text-[var(--veristiq-slate-light)] mb-6">
                                 When a draw is triggered, the eligible entry pool is locked and the draw is executed as a single atomic operation. The selection method, inputs, timestamp, and result are recorded together, ensuring the outcome cannot be modified, replayed, or recalculated after execution.
                             </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center group">
                        <div className="order-2 md:order-1 animate-in fade-in slide-in-from-left-8 duration-700 delay-500 fill-mode-both">
                             ...
                             <p className="text-lg text-[var(--veristiq-slate-light)] mb-6">
                                 Once complete, the draw is published to a public audit page. This page displays the result, timing, and cryptographic references required for independent verification. Anyone can inspect the record and confirm the integrity of the draw without relying on internal systems or operator claims.
                             </p>
                             <ul className="space-y-3 text-sm">
                                 <li className="flex items-center gap-3">
                                     <Check className="w-5 h-5 text-blue-500" />
                ...
                <div className="grid md:grid-cols-2 gap-16">
                    <div className="group animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both">
                        ...
                        <p className="text-[var(--veristiq-slate-light)] mb-6">
                            Veristiq is designed to integrate alongside existing competition platforms. Operators retain full control of their systems while Veristiq records and verifies draw integrity independently.
                        </p>
                    ...
                    <div className="group animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
                        ...
                        <p className="text-[var(--veristiq-slate-light)] mb-6">
                            Veristiq maps its technical audit capabilities to the transparency and verification expectations outlined in the DCMS Voluntary Code, providing operators with independent evidence to support compliance reviews and enquiries.
                        </p>
