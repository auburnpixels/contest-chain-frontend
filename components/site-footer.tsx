...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/5 bg-brand-obsidian pt-20 pb-10 max-w-7xl mx-auto">
      <div className="mx-auto max-w-content px-6">
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link href="/public" className="hover:text-brand-blue transition-colors">Audit Explorer</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link href="/status" className="hover:text-brand-blue transition-colors">Status</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/5">
             <div className="h-2 w-2 rounded-full bg-accent-mint animate-pulse shadow-[0_0_10px_rgba(16,185,129,0.5)]"></div>
             <span className="font-mono text-accent-mint">System Operational</span>
          </div>
        </div>
      </div>
    </footer>
